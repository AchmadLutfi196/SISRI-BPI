            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div x-data="{ action: '' }">
                        ...
                        <!-- Approve Form -->
                        <form x-show="action === 'approve'" x-cloak method="POST" action="{{ route('dosen.validasi-usulan.approve', $usulan) }}">
                            @csrf
                            <div class="space-y-4">
                                <div>
                        ...
                        <!-- Reject Form -->
                        <form x-show="action === 'reject'" x-cloak method="POST" action="{{ route('dosen.validasi-usulan.reject', $usulan) }}">
                            @csrf
                            <div class="space-y-4">
                                <div>
